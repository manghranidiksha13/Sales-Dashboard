...
Open the dashboard file (double-click the dashboard/template).
Point the data connection to the provided cleaned dataset (or the sample CSV).
Use the date and country filters to explore — everything updates instantly.
